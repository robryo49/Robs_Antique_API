...
public class AntiqueHoeItem extends HoeItem implements AntiqueToolItem {
    public int size;
    ...
    public AntiqueHoeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, AntiqueItemSettings settings) {
    ...
    public boolean isEffectiveOn(BlockState state) {
        ...
        return effective || super.isSuitableFor(state);
    }
