...
public class AntiqueShovelItem extends ShovelItem implements AntiqueToolItem {
    public int size;
    ...
    public AntiqueShovelItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, AntiqueItemSettings settings) {
