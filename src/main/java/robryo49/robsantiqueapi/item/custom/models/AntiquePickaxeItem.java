...
public class AntiquePickaxeItem extends PickaxeItem implements AntiqueToolItem {
    public int size;
    ...
    public AntiquePickaxeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, AntiqueItemSettings settings) {
