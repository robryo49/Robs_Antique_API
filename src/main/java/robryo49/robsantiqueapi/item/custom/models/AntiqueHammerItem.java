...
public class AntiqueHammerItem extends ToolItem implements AntiqueToolItem {
    public int size;
    ...
    public AntiqueHammerItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, AntiqueItemSettings settings) {
