...
public class AntiqueSpearItem extends ToolItem implements AntiqueToolItem {
    public int size;
    ...
    public AntiqueSpearItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, AntiqueItemSettings settings) {
