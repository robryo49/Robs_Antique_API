...
public class AntiqueAxeItem extends AxeItem implements AntiqueToolItem {
    public int size;
    ...
    public AntiqueAxeItem(ToolMaterial toolMaterial, int attackDamage, float attackSpeed, AntiqueItemSettings settings) {
